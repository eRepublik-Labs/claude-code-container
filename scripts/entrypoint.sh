...
if [ "$(id -u)" = "0" ]; then
  ...
  unset CLAUDE_API_KEY
  if [ $# -eq 0 ]; then
    exec su-exec dev env -u CLAUDE_API_KEY PATH="/home/dev/.local/bin:/usr/local/bin:/home/dev/.npm-global/bin:/usr/local/sbin:/usr/sbin:/usr/bin:/sbin:/bin" CLAUDE_PROJECT_DIR=/workspace HOME=/home/dev /bin/bash
  else
    exec su-exec dev env -u CLAUDE_API_KEY PATH="/home/dev/.local/bin:/usr/local/bin:/home/dev/.npm-global/bin:/usr/local/sbin:/usr/sbin:/usr/bin:/sbin:/bin" CLAUDE_PROJECT_DIR=/workspace HOME=/home/dev "$@"
  fi
else
  ...
  unset CLAUDE_API_KEY
  if [ $# -eq 0 ]; then
    exec env -u CLAUDE_API_KEY PATH="/home/dev/.local/bin:/usr/local/bin:/home/dev/.npm-global/bin:/usr/local/sbin:/usr/sbin:/usr/bin:/sbin:/bin" CLAUDE_PROJECT_DIR=/workspace HOME=/home/dev /bin/bash
  else
    exec env -u CLAUDE_API_KEY PATH="/home/dev/.local/bin:/usr/local/bin:/home/dev/.npm-global/bin:/usr/local/sbin:/usr/sbin:/usr/bin:/sbin:/bin" CLAUDE_PROJECT_DIR=/workspace HOME=/home/dev "$@"
  fi
fi